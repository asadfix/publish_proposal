...
\paragraph{Classifier-artifact control.} The full test suite is replicated with a non-lexicon transformer. Only non-invariance convergent across both classifiers is interpreted as a platform mode effect \citep{ludwig2022}; divergent results are flagged as classifier artifacts.
